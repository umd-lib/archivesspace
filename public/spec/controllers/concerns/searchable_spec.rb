  ...
  describe 'set_up_advanced_search' do
    describe 'with params' do
      ...
      it 'builds criteria' do
        ...
        expect(criteria["aq"]).to eq("{\"query\":{\"op\":\"AND\",\"subqueries\":[{\"field\":\"types\",\"value\":\"pui\",\"negated\":false,\"literal\":false,\"jsonmodel_type\":\"field_query\"},{\"op\":\"AND\",\"subqueries\":[{\"op\":\"AND\",\"subqueries\":[{\"field\":\"title\",\"value\":\"*\",\"negated\":false,\"literal\":false,\"jsonmodel_type\":\"field_query\"}],\"jsonmodel_type\":\"boolean_query\"}],\"jsonmodel_type\":\"boolean_query\"}],\"jsonmodel_type\":\"boolean_query\"},\"jsonmodel_type\":\"advanced_query\"}")
